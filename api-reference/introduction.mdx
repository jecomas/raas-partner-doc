...
- **Authentication & Security**: Secure access via API keys and user-specific tokens. Scope model (`partner`, `partner_send`, `partner_full`, etc.): [Partner API scopes](/api-reference/partner-api-scopes).
...
Guidance for **QA and integration testing** against the live Partner API is on **[QA project context](/api-reference/qa-project-context)**. You can also open it from the **Documentation** sidebar under **Introduction**.
