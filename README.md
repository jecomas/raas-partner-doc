...
| [`api-reference/introduction.mdx`](./api-reference/introduction.mdx) | Intro, mTLS, happy path; enlace a QA project context |
| [`api-reference/qa-project-context.mdx`](./api-reference/qa-project-context.mdx) | **QA project context** (menú Introduction); alinear con `docs/qa/PROJECT_CONTEXT.md` |
